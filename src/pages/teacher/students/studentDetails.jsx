      ...
      <div>
        <div>
          ...
          >
            ...
            <p className="font-semibold text-textColor3">Back</p>
          </div>

          {selectedStudent && (
            <div className="my-2 flex flex-wrap sm:flex-nowrap gap-5 border border-bordercolor bg-cardBackground p-5 rounded-lg w-full">
              <div className="h-max">
        ...
        <div>
          <div className="flex gap-4 my-5 card-grid ">
            <div className="bg-cardBackground flex flex-col gap-2 border border-bordercolor rounded-lg p-2 py-4 items-center">
              <Ribbon className="text-blue-400 w-15 h-12" />
              <p>Overall Grade</p>
              <p className="font-semibold text-2xl">A</p>
              <p>90.0% Average</p>
            </div>
            <div className="bg-cardBackground flex flex-col gap-2 pt-4 border border-bordercolor rounded-lg p-2 items-center">
            ...
            <TableCard>
              <TableHeader>
                <tr className=" border-b border-slate-200">
                  <th className="p-3 text-textColor3">Subject</th>
                  <th className="p-3 text-textColor3">Term</th>
                  <th className="p-3 text-textColor3">Score</th>
                  <th className="p-3 text-textColor3">Grade</th>
                  <th className="p-3 text-textColor3">Teacher</th>
                </tr>
              </TableHeader>
              <TableBody>
                {academicPerformance.map((data) => (
                  <tr className=" not-last:border-b border-slate-200">
          ...
          <Tables>
            ...
            <TableCard>
              <TableHeader>
                <tr className=" border-b border-slate-200">
                  <th className="p-3 text-textColor3">Month</th>
                  <th className="p-3 text-textColor3">Present</th>
                  <th className="p-3 text-textColor3">Absent</th>
                  <th className="p-3 text-textColor3">Percentage</th>
                </tr>
              </TableHeader>
              <TableBody>
                {attendance.map((data) => (
        ...
        <footer className="bg-cardBackground flex flex-col gap-5 border border-bordercolor rounded-xl mt-3 py-4 px-4">
