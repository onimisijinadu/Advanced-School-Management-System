...
export const MyClasses = () => {
  ...
  return (
    <>
      <div className="p-2">
        <div className="flex flex-wrap sm:flex-nowrap lg:flex-nowrap justify-between item-center text-textColor2 w-full mb-5">
          <div>
        ...
        <footer className="flex flex-col gap-5 bg-cardBackground border border-slate-200 rounded-lg p-5 mt-5">
