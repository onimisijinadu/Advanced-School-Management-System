...
export const StudentValidation = () => {
  ...
  return (
    <>
      ...
      <div className="my-4">
        <h1 className="text-2xl text-textColor3 sm:text-3xl font-semibold">
          Student Validation
        </h1>
        <p className="text-textColor2 py-1">
          Verify student enrollment status by ID
        </p>
      </div>
      {/* Validation form and Status Message Conatiner */}
      <div className="flex  flex-col gap-3 bg-cardBackground p-4 border border-bordercolor rounded-xl">
      ...
      <div className="flex flex-col p-5 w-full bg-cardBackground border border-bordercolor rounded-xl my-5">
